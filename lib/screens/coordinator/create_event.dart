...
class _CreateEventState extends State<CreateEvent> {
  ...
  Future<void> uploadImage() async {
    ...
    StorageMethods storageMethods = StorageMethods();           //handles storage operations
    url = await storageMethods.uploadImagetoStorage(_file!);  //Calls uploadImagetoStorage method with the selected file (_file) and awaits the result to get the URL of the uploaded image.
